...
| [operating-leverage.md](operating-leverage.md) | **Post-v0.2.0 chapter** — OL-001 is active; first target is 10 supervised real-revenue missions, then the 100-mission baseline. |
