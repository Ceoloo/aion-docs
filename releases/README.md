...
- Next engineering checkpoint: **Mission 008 — earned autonomy policy** (then M009 live external execution). M006-complete baseline remains immutable; prefer next RC after M008; final v0.2.0 still deferred.
