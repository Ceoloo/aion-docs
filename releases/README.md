...
- Next engineering checkpoint: **Mission 009 — live GHL client execution plane** (then consider `execution-platform-v0.2.0`). M006-complete baseline remains immutable; final v0.2.0 still deferred until M009 greens.
